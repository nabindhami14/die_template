(() => {
    ...
    module.exports = async (req, res, next) => {
        ...
        const payload = requestHelper(req, res, cbs.admin_service.LoginRequest)
        ...
        try {
            client.loginAdmin(payload, meta, grpcClientHelper.setTimeOut(), (err, response) => {
                ...
                return responseHelper.sendSuccessResponse(response.status, response, cbs.admin_service.LoginResponse, res);
            });
        } catch (err) {
